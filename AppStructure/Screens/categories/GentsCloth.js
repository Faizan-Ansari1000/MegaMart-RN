...
export default function GentsCloth({ navigation }) {
    ...
    const getData = useCallback(async () => {
        try {
            setLoader(true);
            const res = await ApiInstance.get('/product/gentsclothes');
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.heading}>Gents Cloth</Text>
            {loader ? (
                <View style={styles.loaderContainer}>
                    <Image source={{ uri: 'https://media.geeksforgeeks.org/wp-content/uploads/20210722235713/hb.gif' }} style={styles.loader} />
                </View>
            ) : null}
